...
static int mipi_dsi_panel_power(int on)
{
	...
	if (!dsi_power_on) {
		...
		/* Changed from 3000000 to 3100000 by Oppo */
...
void __init apq8064_init_fb(void)
{
	...
	/* TODO - clean this up, since we'll only ever be mtp... */
	if (machine_is_apq8064_liquid())
