...
VREG_CONSUMERS(L8) = {
	...
	/* Next four added by oppo, may be able to remove s5k8aay */
...
VREG_CONSUMERS(L16) = {
	...
	/*
	 * Next three lines added by oppo.
	 * 4-0010 was merged upstream so we don't readd it
	 */
...
VREG_CONSUMERS(LVS5) = {
	...
	/* Oppo additions not found upstream below.  Consider removing s5k8aay stuff later */
...
VREG_CONSUMERS(LVS2) = {
	...
	/* we don't actually have s5k8aay so consider deleting this */
...
apq8064_rpm_regulator_init_data[] __devinitdata = {
	...
	/* L9 modified by oppo - 3000000 to 2850000 for sensor*/
	RPM_LDO(L9,  0, 1, 0, 2850000, 2850000, NULL,          0,     0),
	/* L10 modified by oppo - change upper limit to 3000000 for wifi */
	RPM_LDO(L10, 0, 1, 0, 2900000, 3000000, NULL,          0,     0),
	/* L11 increased from 3000000 to 3100000 by oppo for LCD */
	RPM_LDO(L11, 0, 1, 0, 3100000, 3100000, NULL,          0,     0),
	RPM_LDO(L12, 0, 1, 0, 1200000, 1200000, "8921_s4",     0,     0),
	RPM_LDO(L13, 0, 0, 0, 2220000, 2220000, NULL,          0,     0),
	RPM_LDO(L14, 0, 1, 0, 1800000, 1800000, NULL,          0,     0),
	/* L15 modified by oppo for DVT headset detect */
	...
	/* L21 modified by oppo for wifi - 1050000 to 1800000 */
	RPM_LDO(L21, 0, 1, 0, 1800000, 1800000, NULL,          0,     0),
	/* L22 modified by oppo for LCD - 2600000 to 1800000/2200000 */
