...
/* OPPO 2012-07-19 yxq added begin for main camera's RST_N */
	{
		.gpio = 33,
		.settings = {
			[GPIOMUX_ACTIVE]	= &cam_settings[2],
...
/* OPPO 2012-08-06 yxq added begin for torch */
	{
		.gpio = 36,
		.settings = {
			[GPIOMUX_ACTIVE]	= &cam_settings[2],
...
/* OPPO 2012-08-06 yxq added begin for front camera's PWD_N */
	{
		.gpio = 37,
		.settings = {
			[GPIOMUX_ACTIVE]	= &cam_settings[2],
...
/* OPPO 2012-07-19 yxq modified begin for led */
#define VFE_CAMIF_TIMER1_GPIO 36 // will be modified
#define VFE_CAMIF_TIMER2_GPIO 1  // will be modified
...
/* OPPO 2012-07-19 yxq added begin for led */
...
//oppo modified the items below, but CAF did too.  Going with CAF for now.
...
//Oppo had a ton of #if 0s that came out to - no change!
...
static struct camera_vreg_t apq8064_s5k6a3yx_vreg[] = {
	{"cam_vana", REG_LDO, 2800000, 2850000, 85600},
	//{"cam_vdig", REG_VS, 1225000, 1225000, 105000},
	{"cam_vio", REG_VS, 0, 0, 0},
	{"cam_vaf", REG_LDO, 2800000, 2850000, 300000},
};
