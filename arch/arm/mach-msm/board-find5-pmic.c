...
apq8064_pm8921_rtc_pdata = {
  /*
   * TODO:  Consider enabling rtc_write_enable later after bringup
   * This is a GSM device with offboard modem so it should be OK.
   */
...
#define RSENSE_UOHM		20000

/*
 * Either oppo screwed up very badly, or we have the new 4.35v batt chemistry.
 * Since find5s aren't blowing up right and left, assume 4.35v chemistry.
 */
...
apq8064_pm8921_chg_pdata __devinitdata = {
	...
	.warm_bat_voltage	= 4180,
	.vin_min  = 4500,
	/* These depend on Oppo's changes to drivers/power */
...
apq8064_pm8921_bms_pdata __devinitdata = {
	...
	.rconn_mohm			= 28,
	/* Oppo low voltage handling next two lines */
