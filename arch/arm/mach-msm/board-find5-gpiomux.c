...
struct msm_gpiomux_config vcap_configs[] = {
	...
	/* Added by oppo - lcd 5v_enable for dvt */
	{
		.gpio = 81,
		.settings = {
	...
	},
	{
		.gpio = 83,
		.settings = {
			[GPIOMUX_SUSPENDED] =	&gpio_vcap_config[0],
			[GPIOMUX_ACTIVE] =		&gpio_vcap_config[0],
		}
	},
	{
		.gpio = 87,
...
#endif
	/* Next two GPIOs were added by Oppo */
	{
		.gpio      = 51,		/* GSBI5 UART*/
		.settings = {
...
/* Backlight enable - added by oppo */
