...
static int  current_pcb_version_num = 99;
...
int __init board_pcb_verson_init(char *s)
{
	...
	if (!strcmp(s, "evb"))
		current_pcb_version_num = 10;
	else if (!strcmp(s, "evt"))
		current_pcb_version_num = 20;
	else if (!strcmp(s, "dvt"))
		current_pcb_version_num = 30;
	else if (!strcmp(s, "pvt"))
		current_pcb_version_num = 40;
...
/* very vague name from oppo here...  consider renaming... */
...
static void __init reserve_rtb_memory(void)
{
  ...
  /* This is disabled in factory test mode by oppo - probably irrelevant but keep it in */
...
static struct android_usb_platform_data android_usb_pdata = {
	...
	/*
	 * The item below was added by oppo.
	 * It may be to support features of the factory firmware
	 * not needed for CyanogenMod, but keep it in for now.
	 */
	.cdrom = true,
};
...
static struct wcd9xxx_pdata apq8064_tabla_platform_data = {
	...
	/* Oppo made changes to micbias settings */
	.micbias = {
...
/* ramconsole support added by oppo */
...
/* OPPO 2012-12-22 yxq added end */

/* OPPO 2012-12-12 yxq added begin for s5k6a3yx on GSBI1(EVT) */
...
/* OPPO 2012-10-21 yxq added end */
	...
	if (machine_is_apq8064_cdp())
		mach_mask = I2C_SURF;
	else if (machine_is_apq8064_mtp() || machine_is_oppo_find5())
		mach_mask = I2C_FFA;
...
static void __init apq8064_common_init(void)
{
	...
	if (!(machine_is_apq8064_mtp() || machine_is_oppo_find5()))
...
#else
MACHINE_START(OPPO_FIND5, "Oppo Find 5")
#endif
	.map_io = apq8064_map_io,
	.reserve = apq8064_reserve,
	.init_irq = apq8064_init_irq,
